...
/**On form submit, the educator value is added to the details that were sent in the
update to the server, */
  ...
  /**Any changes to the switch will be set to the value of the educator variable in the
state by calling the handleCheck method, */
//--------------------------------------------------------------------------------------
/**The handleCheck method receives the checked Boolean value to indicate whether
    ...
    return (
      <Card className={classes.card}>
        <CardContent>
          ...
          <br/>
{/*  a signed-in user
will need to update their profile. They will see a toggle in the EditProfile view */}
